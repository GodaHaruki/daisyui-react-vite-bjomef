          ...
          <div className="bg-gray-200 md:overflow-hidden">
            <div className="px-4 py-16">
              <div className="relative w-full md:max-w-2xl md:mx-auto text-center">
                <h1 className="font-bold text-gray-800 text-2xl sm:text-3xl md:text-6xl leading-tight mb-6">
                  Flash Anzan
                </h1>
                <h2 className="font-bold text-gray-700 text-xl sm:text-2xl md:text-5xl leading-tight mb-6">
              ...
              >
                <div className="w-16 bg-gray-200 px-2 py-6 overflow-hidden rounded-bl-lg">
                  ...
                  <div className="text-center mb-6">
                    ...
                    <div
                      className="h-2 w-8 mx-auto rounded-f
                    ull bg-gray-300"
                    ></div>
                  </div>
                  <div className="text-center mb-6">
